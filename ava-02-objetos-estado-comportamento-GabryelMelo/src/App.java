public class App {
  public static void main(String[] args) {
    ...
    // As três linhas a seguir não devem compilar pois estes atributos devem ser
    // imutáveis:
    ...
    // EBOOK - titulo = "Os inovadores", paginas = 544
    ...
    EBook AvengersHeroesWelcome = new EBook("Avengers: Heroes Welcome #1", 14);

    try {
      AvengersHeroesWelcome.irParaPagina(16); // deve lançar IllegalArgumentException
      System.out.println(false);
    } catch (IllegalArgumentException e) {
      System.out.println(true);
    }
    ...
    try {
      AvengersHeroesWelcome.irParaPagina(-1); // deve lançar IllegalArgumentException
      System.out.println(false);
    } catch (IllegalArgumentException e) {
      System.out.println(true);
    }
    ...
    try {
      AvengersHeroesWelcome.irParaPagina(0); // deve lançar IllegalArgumentException
      System.out.println(false);
    } catch (IllegalArgumentException e) {
      System.out.println(true);
    }
    ...
    for (int i = 0; i < 13; i++) {
      AvengersHeroesWelcome.virarPagina();
    }
    System.out.println(AvengersHeroesWelcome.lendoPagina == 14);

    for (int i = 0; i < 13; i++) {
      AvengersHeroesWelcome.voltarPagina();
    }
    System.out.println(AvengersHeroesWelcome.lendoPagina == 1);
